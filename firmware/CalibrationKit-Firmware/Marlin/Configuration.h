...
// ULENDO Dev kit users, modify the settings below to match your dev kit and printer:
#define X_DRIVER_TYPE  TMC5160
#define Y_DRIVER_TYPE  TMC5160


#define X_DRIVER_CURRENT_mA 800
#define Y_DRIVER_CURRENT_mA 800
...
// ULENDO MASTER
#define ULNDO_SOFTWARE_SUPPORT

// ULENDO FEATURES
#ifdef ULNDO_SOFTWARE_SUPPORT
  // Toggles changes to connect to digital accelerometer
  // over SPI.
  #define ULNDO_ACCELEROMETER_SUPPORT
  
  // Toggles changes that allow processing of custom G
  // codes to directly control steppers.
  #define ULNDO_STEPPER_SUPPORT

  // Toggles changes that allow generation of sine
  // sweep profiles, motor commands.
  #define ULNDO_SINESWEEP_SUPPORT
#endif
